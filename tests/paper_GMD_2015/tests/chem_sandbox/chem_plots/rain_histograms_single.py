...
# collision kernel
kernels = {"out_hall_pinsky_stratocumulus"} # easy way to add more kernels to this dict and loop over them

# what number of grid cells is:
dry_cover = {"out_hall_pinsky_stratocumulus" : 0} # without cloud
cld_cover = {"out_hall_pinsky_stratocumulus" : 0} # with cloud
rin_cover = {"out_hall_pinsky_stratocumulus" : 0} # with rain
